    ...
    return(
       <section className="about" id="about" >
        ...
        <Container>
            ...
            <p data-aos="fade-up">
            I am a final year undergraduate student of the <span style={{ color: "#4db5ff" }}>Department</span> of Electronic's and  Communication Engineering, <span style={{ color: "#4db5ff" }}>ABES Engineering College, Ghaziabad</span>, India.<br /> I was born in Varanasi, Uttar Pradesh.<br /><br />
